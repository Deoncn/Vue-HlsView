...
`),"color: #fadfa3; background: #030307; padding:5px 0;","background: #fadfa3; padding:5px 0;");const Ks=Ws})(),a.default})())();const Fc={".mp4":{kind:"file",mimeHints:["video/mp4"]},".m4v":{kind:"file",mimeHints:["video/mp4"]},".mov":{kind:"file",mimeHints:["video/quicktime","video/mp4"]},".webm":{kind:"file",mimeHints:["video/webm"]},".ogv":{kind:"file",mimeHints:["video/ogg"]},".ts":{kind:"file",mimeHints:["video/mp2t"]},".mkv":{kind:"file",mimeHints:["video/x-matroska","video/webm"]},".m3u8":{kind:"hls",mimeHints:["application/vnd.apple.mpegurl","application/x-mpegURL"]},".mpd":{kind:"dash",mimeHints:["application/dash+xml"]}};function Yc(e){try{return new URL(e.trim())}catch{return null}}function Nc(e){const t=e.pathname.toLowerCase().split("?")[0],a=t.lastIndexOf(".");return a>=0?t.slice(a):""}function Hc(e){const n=e.hostname.toLowerCase(),t=e.pathname.toLowerCase();return!!(n.includes("youtube.com")||n.includes("youtu.be")||n.includes("bilibili.com")&&(t.includes("/video/")||t.includes("/bangumi/"))||n.includes("vimeo.com")&&!t.endsWith(".mp4"))}function Wc(e){const n=document.createElement("video");return e.some(t=>!!n.canPlayType(t))}async function Kc(e,n){const t=(n==null?void 0:n.timeoutMs)??1e4,a=(n==null?void 0:n.useHlsJsIfAvailable)??!0,r=Yc(e);if(!r)return{ok:!1,reason:"URL 无效"};if(Hc(r))return{ok:!1,reason:"看起来是网页播放页（非媒体直链）"};const l=Nc(r),u=Fc[l];u&&u.kind==="file"&&Wc(u.mimeHints);const A=document.createElement("video");return A.preload="metadata",A.muted=!0,(()=>new Promise(g=>{const f=window.setTimeout(()=>{B(),g({ok:!1,reason:"加载超时，可能不是可播放直链或被 CORS/鉴权拦截"})},t),C=k=>{window.clearTimeout(f),B(),g(k)};function B(){A.src="",A.remove()}A.addEventListener("loadedmetadata",()=>{if((u==null?void 0:u.kind)==="hls")return C({ok:!0,kind:"hls",reason:"HLS 元数据已加载"});if((u==null?void 0:u.kind)==="dash")return C({ok:!0,kind:"dash",reason:"DASH 元数据已加载"});C({ok:!0,kind:"file",reason:"视频元数据已加载"})}),A.addEventListener("error",()=>{var k,R;if((u==null?void 0:u.kind)==="hls"&&a&&((R=(k=window.Hls)==null?void 0:k.isSupported)!=null&&R.call(k)))try{const _=window.Hls,q=new _;q.on(_.Events.MANIFEST_PARSED,()=>{q.destroy(),C({ok:!0,kind:"hls",reason:"hls.js 成功解析清单"})}),q.on(_.Events.ERROR,()=>{q.destroy(),C({ok:!1,reason:"hls.js 解析失败，可能不是有效的 m3u8"})}),q.loadSource(r.toString()),q.attachMedia(A);return}catch{}C({ok:!1,reason:"无法加载为媒体资源（网络错误、CORS、鉴权或非媒体）"})}),A.src=r.toString(),document.body.appendChild(A)}))()}const pl=(e,n)=>{const t=e.__vccOpts||e;for(const[a,r]of n)t[a]=r;return t},Qc={data(){return{NewSrc:""}},methods:{initializeDplayer(){new oi({container:document.getElementById("dplayer"),video:{url:"https://kaneki.dynv6.net/d/oss/Picture/Lady%20Gaga%20-%20Applause.mp4?sign=7994f6avjrvtMvEgweiFUWB8Ojjq7Uhe75v-A8UwkIA=:0"},subtitle:{url:"https://kaneki.dynv6.net/d/oss/Picture/Lady%20Gaga%20-%20Applause.vtt?sign=zQqxUK6aiT13X3IpdwgqbAzqrnitL_C0waUDevW1QxI=:0",type:"webvtt",fontSize:"25px",bottom:"5%",color:"#e5ccff"},theme:"#4378ff"})},Dplayer(e){new oi({container:document.getElementById("dplayer"),video:{url:e},theme:"#4378ff"})},ChangeVideo(){Kc(this.NewSrc).then(e=>{e.ok?(console.log("可播放，类型：",e.kind,e.reason),this.Dplayer(this.NewSrc),console.log("实现 DPLAYER")):(console.warn("不可播放：未知后缀",e.reason),alert("不可播放：未知后缀",e.reason))})}},mounted(){this.initializeDplayer()}},Vc=X("link",{rel:"stylesheet",href:""},null,-1),Zc={align:"center"},Jc=X("p",null,[X("div",{id:"dplayer"})],-1);function Xc(e,n,t,a,r,l){return jn(),nt(We,null,[Vc,X("div",Zc,[X("p",null,[X("button",{onClick:n[0]||(n[0]=(...u)=>l.ChangeVideo&&l.ChangeVideo(...u))},"检测链接是否可用并应用"),dn(),et(X("input",{style:{width:"800px"},type:"text","onUpdate:modelValue":n[1]||(n[1]=u=>r.NewSrc=u)},null,512),[[rt,r.NewSrc]])]),Jc])],64)}const $c=pl(Qc,[["render",Xc]]);const Gc={components:{Mp4Page:$c},setup(){},name:"App",data(){return{istext:!1,inputid:0,inputdescription:"",inputname:"",inputsrc:"",contt:1,contexts:JSON.parse(localStorage.getItem("VideoList"))||[{id:1,name:"圣职者",src:"https://baidu.com",description:"你好！"},{id:2,name:"圣职者2",src:"https://baidu.com",description:"你好！"}],context:JSON.parse(localStorage.getItem("context"))||`本地数据为空：
 ...
 https://s-bj-2339-mydisk1.oss.dogecdn.com/movie/yrcy_m3u8/YRCY_m3u8.m3u8`}},methods:{datatoContext(e){localStorage.setItem("context",JSON.stringify(e)),alert("保存成功")},datatoVideoList(e){localStorage.setItem("VideoList",JSON.stringify(e)),alert("保存成功")},toggletext(){this.istext=!this.istext},addVideos(e,n,t,a){crypto.randomUUID(),console.log("开发中.");const r={id:e,name:t,src:a,description:n};this.contexts.push(r)},deletevideo(e){confirm("确认要删除吗？")==!0?(console.log("确认删除"),this.contexts.splice(e,1)):console.log("否")},copythevideosrc(e){console.log(e.src)},copyTextToClipboard(e){var n=document.createElement("textarea");n.value=e,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),alert("复制成功!")}},watch:{}},eu={id:"app"},nu=X("h1",null,[X("img",{width:"30",src:"https://avatars.githubusercontent.com/u/51418619?v=4",alt:""}),dn(" 简易视频播放器 ")],-1),tu=X("p",null,[dn(" DPlayer "),X("a",{href:"https://dplayer.diygod.dev/guide.html",target:"_blank"}," DPlayer "),dn(" |👉 "),X("a",{href:"https://github.com/DIYgod/DPlayer",target:"_blank"}," Github ")],-1),ru={style:{border:"1cm solid rebeccapurple"}},ou={key:0,id:"no-downloads"},au=X("div",null,[X("div",{class:"illustration"}),X("span",null,"您添加的视频会显示在此处")],-1),iu=[au],lu={id:"downloadsList"},su={id:"content","focus-row-container":"",class:"is-active focus-row-active"},pu=X("div",{id:"file-icon-wrapper",class:"icon-wrapper","aria-hidden":"true"},[X("img",{class:"icon",id:"file-icon",src:"https://www.gstatic.com/images/icons/material/apps/fonts/1x/catalog/v5/favicon.svg"})],-1),du={id:"details"},cu={id:"title-area",role:"gridcell"},uu={id:"name",hidden:""},fu=X("span",{id:"tag"},null,-1),Au={role:"gridcell"},yu=["onClick"],hu={id:"description",role:"gridcell"},mu={class:"more-options"},bu={role:"gridcell"},gu={class:"icon-clear",id:"remove",title:"从列表中移除","focus-row-control":"","focus-type":"remove",style:{},"aria-disabled":"false",role:"button",tabindex:"0"},vu={id:"icon"},xu=["onClick"],Eu=X("span",{class:"material-icons"}," close ",-1),wu=[Eu],Cu=X("br",null,null,-1),ku=X("br",null,null,-1);function Bu(e,n,t,a,r,l){const u=yd("Mp4Page");return jn(),nt("div",eu,[X("header",null,[nu,fn(u),tu]),X("main",null,[X("div",ru,[X("p",null,[X("p",null,[dn(" 视频ID ："),et(X("input",{"onUpdate:modelValue":n[0]||(n[0]=A=>r.inputid=A),type:"text"},null,512),[[rt,r.inputid]])]),X("p",null,[dn(" 视频名称 ："),et(X("input",{"onUpdate:modelValue":n[1]||(n[1]=A=>r.inputname=A),type:"text"},null,512),[[rt,r.inputname]])]),X("p",null,[dn(" 视频路径 ："),et(X("input",{"onUpdate:modelValue":n[2]||(n[2]=A=>r.inputsrc=A),type:"text",style:{width:"800px"}},null,512),[[rt,r.inputsrc]])]),X("p",null,[dn(" 视频描述 ："),et(X("input",{"onUpdate:modelValue":n[3]||(n[3]=A=>r.inputdescription=A),type:"text"},null,512),[[rt,r.inputdescription]])]),X("button",{onClick:n[4]||(n[4]=A=>l.addVideos(r.inputid,r.inputdescription,r.inputname,r.inputsrc))}," 添加 "),X("button",{onClick:n[5]||(n[5]=A=>l.datatoVideoList(r.contexts))},"保存")]),r.contt?Gr("",!0):(jn(),nt("div",ou,iu)),X("div",lu,[r.contt?(jn(!0),nt(We,{key:0},bd(r.contexts,(A,b)=>(jn(),nt("div",{key:b},[X("div",su,[pu,X("div",du,[X("div",cu,[X("a",{is:"action-link",id:"file-link","focus-type":"fileLink",tabindex:"0",role:"link",onClick:n[6]||(n[6]=(...g)=>l.copythevideosrc&&l.copythevideosrc(...g)),href:"#"},Dt(A.name),1),X("span",uu,Dt(A.name),1),fu]),X("div",Au,[X("a",{id:"url","focus-type":"url",href:"javascript:",onClick:g=>l.copyTextToClipboard(A.src),tabindex:"0"},Dt(A.src),9,yu)]),X("div",hu,Dt(b)+" : "+Dt(A.description),1)]),X("div",mu,[X("div",bu,[X("div",gu,[X("div",vu,[X("button",{onClick:g=>l.deletevideo(b)},wu,8,xu)])])])])])]))),128)):Gr("",!0)])]),X("p",null,[r.istext?et((jn(),nt("textarea",{key:0,cols:"85",rows:"30","onUpdate:modelValue":n[7]||(n[7]=A=>r.context=A)},null,512)),[[rt,r.context]]):Gr("",!0)]),X("p",null,[X("button",{onClick:n[8]||(n[8]=A=>l.toggletext())}," 显示或隐藏文字区 "),dn(" | "),X("button",{onClick:n[9]||(n[9]=A=>l.datatoContext(r.context))}," 保存(文字到 localStorge) ")]),Cu,ku])])}const Su=pl(Gc,[["render",Bu]]);const Iu=Ec(Su);Iu.mount("#app");
